...
import dhaval from "../img/dhaval.png";
                    ...
                    <div className="row">
                        ...
                        <div className="title-box text-center">
                            ...
                            <div className="box-shadow-full">
                                <div className="row">
                                        ...
                                        <div className="row">
                                            <div className="col-sm-6 col-md-5" style={{margin: "0 auto"}}>
                                                <div className="about-img" style={{textAlign: "center"}}>
                                                    <img src={dhaval} className="img-fluid rounded b-shadow-a" alt=""/>
                                                    <p className="subtitle-a text-center">Dhaval Shah
                                                    <br />Founder
                                                    <br />0414 297 226
                                                    </p>
                                                </div>
                                    ...
                                    <div className="col-md-6">
                                        <div className="row">
                                            <div className="col-sm-6 col-md-5" style={{margin: "0 auto"}}>
                                                <div className="about-img" style={{textAlign: "center"}}>
                                                    <img src={matt} className="img-fluid rounded b-shadow-a" alt=""/>
                                                    <p className="subtitle-a text-center">Matthew Persson 
                                                    <br />Founder
                                                    <br />0478 012 545
                                                    </p>
                                                </div>
                                ...
                                <div className="row">
                                    <p style={{ textAlign: 'center' }}>“When passion meets work, you truly get something remarkable”<p>
                                    </p>Our team has over two years experience of delivering aerial photography and videography within the real estate market as a licensed and certified drone (RPA) operator, authorised under CASA. Through a fluid blend of aerial perspectives and ground photography/videography we, as a team are successfully able to market or advertise your asset or business, the way you want to be seen.</p>
                                </div>
                            </div>
                        </div>
                    </div>
