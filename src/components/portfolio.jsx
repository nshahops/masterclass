              ...
              <div className="row">
                <div className="col-md-4">
                  <div className="work-box">
                    <Iframe url="https://player.vimeo.com/video/369293004"
                      width="350px"
                      height="200px"
                      id="myId"
                    ...
                    <div className="work-content">
                      <div className="row">
                        <div className="col-sm-8">
                          <h2 className="w-title">Industrial Warehouse</h2>
                          <div className="w-more">
                            <span className="w-ctegory">Drone Walkthrough of Industrial Site</span> {/*/ <span className="w-date">18 Sep. 2018</span>*/}
                          </div>
                        </div>
